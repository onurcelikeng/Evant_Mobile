...
export default class Timeline extends Component {
  ...
  _renderTime(rowData, sectionID, rowID) {
      ...
      return (
        ...
        <View style={[styles.timeContainer, this.props.timeContainerStyle, {borderRadius: 30, overflow: 'hidden'}]}>
          <Text style={[styles.time, this.props.timeStyle]}>{moment(rowData.createAt).format('L')}</Text>
        </View>
        </View>
      )
  }
  ...
  _renderEvent(rowData, sectionID, rowID){
    ...
    let isLast = this.state.data.slice(-1)[0]+1 === rowData
    ...
    return (
      ...
      <TouchableOpacity activeOpacity={1} disabled={this.props.onEventPress == null} 
