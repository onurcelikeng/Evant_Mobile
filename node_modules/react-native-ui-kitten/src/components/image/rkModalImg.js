...
export class RkModalImg extends RkComponent {
  ...
  static opacity = new Animated.Value(1);
  ...
  _renderImage(source, props) {
    return (
      <TouchableWithoutFeedback style={{flex:1}}
                                onPress={() => RkModalImg._toggleControls()}>
        <Image source={source} {...props}/>
      </TouchableWithoutFeedback>
    )
  }

  static _toggleControls() {
    Animated.timing(RkModalImg.opacity, {
      toValue: RkModalImg.opacity._value ? 0 : 1
    }).start()
  }
      ...
      <View>
        ...
        <Modal supportedOrientations={['portrait', 'landscape']}
          ...
          <View style={[modal, modalStyle]}>
            ...
            <Animated.View style={[this.styles.footer, {opacity: RkModalImg.opacity}]}>
