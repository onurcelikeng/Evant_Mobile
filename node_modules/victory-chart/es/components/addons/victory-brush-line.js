...
var panBox = function (props, position) {
  ...
  var range = currentDomain ? toRange(props, currentDomain) : toRange(props, brushDomain);
...
var VictoryBrushLine = function (_React$Component) {
  ...
  _createClass(VictoryBrushLine, [{
    ...
    value: function renderHandles(props) {
      ...
      var minDatum = _assign({ handleValue: Collection.getMinValue(domain) }, datum);
      var maxDatum = _assign({ handleValue: Collection.getMaxValue(domain) }, datum);
  ...
  return props.disable ? undefined : [{
    ...
    eventHandlers: {
      onMouseEnter: function (evt, targetProps) {
        ...
        var minimumDomain = getMinimumDomain();
        ...
        var activeBrushes = {
          brushArea: _isEqual(currentDomain, fullDomain) || _isEqual(currentDomain, minimumDomain),
          brush: withinBound(position, range) && !_isEqual(fullDomain, currentDomain),
          minHandle: activeHandle === "min" || activeHandle === "both",
          maxHandle: activeHandle === "min" || activeHandle === "both"
        };
        return [{
          mutation: function () {
            return { activeBrushes: activeBrushes, currentDomain: targetProps.currentDomain };
          }
        }];
      },
      onMouseDown: function (evt, targetProps) {
        ...
        if (activeHandle) {
          return [{
            mutation: function () {
              return {
                isSelecting: true, activeHandle: activeHandle, currentDomain: currentDomain, cachedBrushDomain: brushDomain,
                startPosition: position, activeBrushes: activeBrushes
              };
            }
          }];
        } else if (withinBound(position, range) && !_isEqual(fullDomain, currentDomain)) {
          ...
          return [{
            mutation: function () {
              return {
                ...
                currentDomain: currentDomain, cachedBrushDomain: brushDomain, activeBrushes: activeBrushes
              };
            }
          }];
        } else {
      ...
      onMouseMove: function (evt, targetProps) {
        ...
        var activeBrushes = {
          brushArea: _isEqual(domain, fullDomain) || _isEqual(domain, getMinimumDomain()),
          brush: withinBound(position, initialRange) && !_isEqual(fullDomain, domain),
          minHandle: activeHandle === "min" || activeHandle === "both",
        ...
        if (!targetProps.isPanning && !targetProps.isSelecting) {
          return [{
            mutation: function () {
              return {
                activeBrushes: activeBrushes, currentDomain: targetProps.currentDomain, cachedBrushDomain: cachedBrushDomain
              };
            }
          }];
        }
        if (allowDrag && isPanning) {
          ...
          var mutatedProps = {
            startPosition: startPosition, isPanning: true, currentDomain: currentDomain, cachedBrushDomain: cachedBrushDomain,
          ...
          var _range = toRange(targetProps, targetProps.currentDomain);
          ...
          var _mutatedProps = {
            currentDomain: _currentDomain, startPosition: targetProps.startPosition,
      ...
      onMouseUp: function (evt, targetProps) {
        ...
        var mutatedProps = {
          ...
          currentDomain: currentDomain, cachedBrushDomain: cachedBrushDomain, activeBrushes: activeBrushes
        };
      ...
      onMouseLeave: function (evt, targetProps) {
        var currentDomain = targetProps.currentDomain,
            cachedBrushDomain = targetProps.cachedBrushDomain;
        ...
        return [{
          mutation: function () {
            return {
              isPanning: false, isSelecting: false, activeHandle: null, startPosition: null,
              currentDomain: currentDomain, cachedBrushDomain: cachedBrushDomain, activeBrushes: {}
            };
          }
        }];
      }
