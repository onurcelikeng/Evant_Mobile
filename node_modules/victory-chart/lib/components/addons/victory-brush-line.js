  ...
  return props.disable ? undefined : [{
    ...
    eventHandlers: {
      onMouseEnter: function (evt, targetProps) {
        ...
        var activeBrushes = {
          brushArea: (0, _isEqual3.default)(currentDomain, fullDomain) || (0, _isEqual3.default)(currentDomain, minimumDomain),
      ...
      onMouseMove: function (evt, targetProps) {
        ...
        var activeBrushes = {
          brushArea: (0, _isEqual3.default)(domain, fullDomain) || (0, _isEqual3.default)(domain, getMinimumDomain()),
